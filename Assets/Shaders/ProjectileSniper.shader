Shader "Cloister/Projectile/Sniper"
{
    Properties
    {
    }
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex * (v.uv.y * 0.7 + 0.3));
                o.uv = v.uv;
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				result = fixed4(result.g * 0.8f * w, result.b * w, result.r * 1.2 * w, result.a);
